...
def print_info():
    print(Fore.WHITE + "Car Parking Multiplayer termux" + Style.RESET_ALL)
    print(Fore.RED + "By Suprememodz and Heele" + Style.RESET_ALL)
    print(Fore.RED + "Bot to get access key @HeeleToolBot" + Style.RESET_ALL)
